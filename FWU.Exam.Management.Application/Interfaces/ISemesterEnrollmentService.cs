...
public interface ISemesterEnrollmentService
{
    ...
    Task<(int Created, int Skipped)> BulkCreateEnrollmentsAsync(List<int> admissionIds, int semesterId, EnrollmentType? enrollmentType = null);
    Task<(int Created, int Skipped)> BulkCreateAllEnrollmentsAsync(string? search, int? academicYearId, int? collegeId, int? programId, int semesterId, EnrollmentType? enrollmentType = null);
