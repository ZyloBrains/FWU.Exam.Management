...
{
    Task<(List<College> Items, int TotalCount)> GetCollegesAsync(int page, int pageSize, string? search, string sort, string sortDir, int? organizationId = null);
    Task<List<College>> GetFilteredItemsAsync(string? search, string sort, string sortDir, int? organizationId = null);
