...
public interface ISubjectOfferingService
{
    ...
    Task<Dictionary<int, List<int>>> GetExistingSubjectCatalogIdsBySemesterAsync(int programId, int curriculumVersionId);
    Task<List<SelectOption>> GetSemestersByCurriculumVersionAsync(int curriculumVersionId, int? programId = null);
    Task<List<ProgramOfferingSummary>> GetProgramsByCurriculumVersionAsync(int curriculumVersionId);
    Task<List<SemesterOfferingSummary>> GetSemestersByProgramAsync(int programId, int curriculumVersionId);
    Task<List<SemesterOfferingSummary>> GetSemestersForOfferingAsync(int programId, int curriculumVersionId);
    ...
    Task<List<SubjectOffering>> GetSearchResultsAsync(int? curriculumVersionId, int? programId, int? semesterId);
