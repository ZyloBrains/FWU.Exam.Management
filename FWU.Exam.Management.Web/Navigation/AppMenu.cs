    ...
    [
        ...
        new("Payments", "Payments", "fa-money-bill-wave",
            ...
            [
                ...
                M("Payment History", "fa-clock-rotate-left", ["paymenthistory.view"], R("Payments", "PaymentHistory", "Index"), ["history", "payment history", "search payment", "all payments", "receipt"]),
                ...
                M("eSewa Transaction Verification", "fa-search", ["paymentreconciliation.view"], R("Payments", "ESewaVerification", "Index"), ["esewa", "verify", "transaction_uuid", "transaction"]),
            ],
            Landing: R(null, "Section", "Payments"),
            SectionActiveOns: [R("Payments", "Banks", null), R("Payments", "PaymentTypes", null), R("Payments", "BillTitles", null), R("Payments", "PaymentReconciliation", null), R("Payments", "PaymentHistory", null), R("Payments", "PaymentVerification", null), R("Payments", "ESewaVerification", null)]),
        ...
        new("Student Portal", "Student Portal", "fa-user-graduate",
            ...
            [
                ...
                // Hidden for now - will be made visible to students later.
                ...
                // Hidden for now - depends on the Marksheet page for subject selection.
