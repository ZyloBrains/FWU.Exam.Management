...
namespace fwu_examination_management_system.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeId,PaymentTypeName,IsActive")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentTypeId,PaymentTypeName,IsActive")] PaymentType paymentType)
        {
