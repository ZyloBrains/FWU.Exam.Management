...
public static class ProgramSeeder
{
    public static async Task SeedProgramsAsync(IServiceProvider serviceProvider)
    {
        ...
        var programs = new[]
        {
            ...
            new Program { LevelId = undergradLevel.Id, FacultyId = 7, ProgramCode = "L092", ProgramName = "Bachelor's Degree in Civil Engineering", ShortName = "BCE", Duration = 8, GrandTotalMarks = 4000, HasMultipleIntakes = false, IsActive = true },
            new Program { LevelId = undergradLevel.Id, FacultyId = 7, ProgramCode = "L117", ProgramName = "Bachelor's Degree in Computer Engineering", ShortName = "BCT", Duration = 8, GrandTotalMarks = 4000, HasMultipleIntakes = false, IsActive = true },
            ...
            new Program { LevelId = graduateLevel.Id, FacultyId = 7, ProgramCode = "L131", ProgramName = "Master of Science (M.Sc.) in Construction Project Management", ShortName = "M.Sc.CPM", Duration = 4, GrandTotalMarks = 1600, HasMultipleIntakes = false, IsActive = true },
