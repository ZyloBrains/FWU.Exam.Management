...
namespace FWU.Exam.Management.Infrastructure.Migrations
{
    ...
    [Migration("20260809073414_ReplaceTenantCollegesWithCollegeFaculties")]
    partial class ReplaceTenantCollegesWithCollegeFaculties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.CollegeAdmins.CollegeAdminSubjectAssignment", b =>
                {
                    ...
                    b.Property<string>("CollegeAdminUserId")
                        .IsRequired()
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.Colleges.CollegeFaculty", b =>
                {
                    ...
                    b.HasKey("CollegeId", "FacultyId");

                    b.HasIndex("FacultyId");

                    b.HasIndex("TenantId");

                    b.ToTable("CollegeFaculties", (string)null);
                });
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.Exams.ExamScheduleCollegeApproval", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("RequestedApprovalDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ExamScheduleId", "CollegeId")
                        .IsUnique();

                    b.ToTable("ExamScheduleCollegeApprovals");
                });
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.GumpNowEmailConfiguration", b =>
                {
                    ...
                    b.Property<bool>("OverrideUnsubscription")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.ToTable("GumpNowEmailConfigurations");
                });

            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.GumpNowEmailLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.Payments.PaymentType", b =>
                {
                    ...
                    b.HasIndex("TenantId", "PaymentTypeName")
                        .IsUnique()
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.Semesters.ProgramSemester", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.SmsLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.Students.StudentRegistration", b =>
                {
                    ...
                    b.HasIndex("StudentAdmissionId")
                        .IsUnique()
                        .HasFilter("[StudentAdmissionId] IS NOT NULL");
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.CollegeAdmins.CollegeAdminSubjectAssignment", b =>
                {
                    b.HasOne("FWU.Exam.Management.Infrastructure.Data.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("CollegeAdminUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.Exams.ExamRegistration", b =>
                {
                    ...
                    b.HasOne("FWU.Exam.Management.Domain.Entities.Semesters.SemesterEnrollment", "SemesterEnrollment")
                        .WithMany("ExamRegistrations")
            ...
            modelBuilder.Entity("FWU.Exam.Management.Domain.Entities.Students.StudentRegistration", b =>
                {
                    ...
                    b.HasOne("FWU.Exam.Management.Domain.Entities.Students.StudentAdmission", "StudentAdmission")
                        ...
                        .HasForeignKey("FWU.Exam.Management.Domain.Entities.Students.StudentRegistration", "StudentAdmissionId")
                        .OnDelete(DeleteBehavior.Restrict);
