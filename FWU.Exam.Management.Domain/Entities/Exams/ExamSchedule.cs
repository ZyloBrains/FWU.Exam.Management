...
public class ExamSchedule : ITenantScoped
{
    ...
    [MaxLength(1000)]
    [Display(Name = "Practical Subject Offering Ids")]
    public string? PracticalSubjectOfferingIds { get; set; }
    ...
    [NotMapped]
    public List<int>? SelectedPracticalSubjectOfferingIds { get; set; }
